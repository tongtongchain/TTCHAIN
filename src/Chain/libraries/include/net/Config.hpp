...
#define ALP_NET_PROTOCOL_VERSION                        106
...
/**
 * 512 * ALP_BLOCKCHAIN_MAX_PENDING_QUEUE_SIZE * 5 
 */
#define MAX_MESSAGE_SIZE                                (512 * 10000 * 5)
#define ALP_NET_DEFAULT_PEER_CONNECTION_RETRY_TIME      30 // seconds

/**
 * AFter trying all peers, how long to wait before we check to
 * see if there are peers we can try again.
 */
#define ALP_PEER_DATABASE_RETRY_DELAY                   15 // seconds

#define ALP_NET_PEER_HANDSHAKE_INACTIVITY_TIMEOUT       10

#define ALP_NET_PEER_DISCONNECT_TIMEOUT                 20

#define ALP_NET_TEST_SEED_IP                            "172.16.28.43" // autogenerated
#define ALP_NET_DEFAULT_P2P_PORT                        62896
#define ALP_NET_TEST_P2P_PORT                           (ALP_NET_DEFAULT_P2P_PORT + 100) 
#define ALP_NET_DEFAULT_DESIRED_CONNECTIONS             20
#define ALP_NET_DELEGATE_DESIRED_CONNECTIONS            50
#define ALP_NET_DEFAULT_MAX_CONNECTIONS                 200

#define ALP_NET_MAXIMUM_QUEUED_MESSAGES_IN_BYTES        (512 * 10000 * 10)
 ...
 */
#define ALP_NET_FUTURE_SYNC_BLOCKS_GRACE_PERIOD_SEC     (60 * 60)

#define ALP_NET_INSUFFICIENT_RELAY_FEE_PENALTY_SEC      15

#define ALP_NET_MAX_INVENTORY_SIZE_IN_MINUTES           2

#define ALP_NET_MAX_BLOCKS_PER_PEER_DURING_SYNCING      100
 ...
 */
#define ALP_NET_MIN_BLOCK_IDS_TO_PREFETCH               10000
#define ALP_NET_MAX_ITEMS_PER_PEER_DURING_NORMAL_OPERATION 1