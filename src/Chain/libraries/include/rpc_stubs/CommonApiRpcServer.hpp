...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        public:
			...
			fc::variant wallet_update_transfer_config_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
			fc::variant wallet_update_transfer_config_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
