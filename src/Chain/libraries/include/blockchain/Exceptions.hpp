...
namespace thinkyoung {
    namespace blockchain {
		...
		//Add zxj
		FC_DECLARE_DERIVED_EXCEPTION(invalid_delegate_account_name, thinkyoung::blockchain::evaluation_error, 31313, "update_transfer_config is only avaliable for delegates");
