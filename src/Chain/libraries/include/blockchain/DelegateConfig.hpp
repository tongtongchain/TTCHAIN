...
//#define ALP_BLOCKCHAIN_MAX_BLOCK_SIZE (2 * ALP_BLOCKCHAIN_MAX_TRX_SIZE * ALP_BLOCKCHAIN_MAX_PENDING_QUEUE_SIZE)因为产块时间缩短到6秒所以块大小对应缩小0.6倍
#define ALP_BLOCKCHAIN_MAX_BLOCK_SIZE (2 * ALP_BLOCKCHAIN_AVERAGE_TRX_SIZE * ALP_BLOCKCHAIN_MAX_PENDING_QUEUE_SIZE * 0.6)
...
namespace thinkyoung {
    namespace blockchain {
        ...
        struct DelegateConfig
        {
            ...
            ShareType          transaction_min_fee = ALP_DEFAULT_MIN_TRANSACTION_FEE;//mod zxj  ALP_BLOCKCHAIN_PRECISION / 100
