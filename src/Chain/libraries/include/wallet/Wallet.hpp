...
namespace thinkyoung {
    namespace wallet {
		...
		struct TransactionFeeConfiguration
		{
			TransactionFeeConfiguration() : min_transaction_fee(ALP_DEFAULT_MIN_TRANSACTION_FEE), max_transaction_fee(ALP_DEFAULT_MAX_TRANSACTION_FEE), transaction_fee_ratio(ALP_DEFAULT_TRANSACTION_FEE_RATIO){}
			ShareType min_transaction_fee;
			ShareType max_transaction_fee;
        ...
        class Wallet {
          public:
            ...
            */
			...
			//add zxj
			//void                   set_min_transaction_fee(const int& fee);
			//void                   set_max_transaction_fee(const int& fee);
			//void                   set_transaction_fee_ratio(const double& ratio);

			void                   save_transaction_fee_configuration();
            /**
            ...
            */
			...
			//add zxj
			int                  get_min_transaction_fee()const;
			int                  get_max_transaction_fee()const;
			double                 get_transaction_fee_ratio()const;
            /**
            ...
            */
			...
			//Add zxj
			WalletTransactionEntry update_transfer_config(
...
FC_REFLECT(thinkyoung::wallet::TransactionFeeConfiguration,
		 (min_transaction_fee)
		 (max_transaction_fee)
